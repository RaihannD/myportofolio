...
Proyek ini menggunakan Django sebagai framework web, sementara *website*nya sendiri dikembangkan menggunakan HTML dan CSS. Implementasi saat ini berfokus pada pembuatan portofolio statis yang rapi dan responsif serta menerapkan konsep-konsep HTML5 dan CSS3 yang dipelajari selama sesi tutorial dan perkuliahan.
...
Proyek ini dikembangkan secara bertahap menggunakan *feature branch* Git. Setiap fitur utama dikembangkan secara terpisah dan kemudian digabungkan ke dalam *branch* `main`. Pesan *commit* yang deskriptif digunakan untuk mempermudah pemahaman riwayat pengembangan dan mengikuti praktik yang baik.
